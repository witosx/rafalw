#ifndef XTRAS_UTILS_VALUEHOLDER_HPP_
#define XTRAS_UTILS_VALUEHOLDER_HPP_

#include <xtras/utils/FunctionPtr.hpp>
#include <xtras/utils/assert.hpp>
#include <xtras/math.hpp>
#include <type_traits>
#include <memory>
#include <cstdint>
...
private:
    ...
    public:
        ...
        auto emplace(Args&&... args) -> void
        {
            ...
            xtras_assert(m_bufferSize >= sizeof(V));
    ...
    private:
        FunctionPtr<void(const void*)> m_destructor = nullptr;
...
#endif // XTRAS_UTILS_VALUEHOLDER_HPP_
