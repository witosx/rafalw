#ifndef XTRAS_UTILS_INTERFACEVALUE_HPP_
#define XTRAS_UTILS_INTERFACEVALUE_HPP_

#include <xtras/utils/Interface.hpp>
#include <xtras/utils/ValueHolder.hpp>
...
#endif // XTRAS_UTILS_INTERFACEVALUE_HPP_
