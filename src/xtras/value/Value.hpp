#ifndef XTRAS_VALUE_VALUE_HPP_
#define XTRAS_VALUE_VALUE_HPP_

#include <xtras/units.hpp>
#include <type_traits>
#include <functional>
...
template<typename U, typename Q>
struct hash<xtras::value::Value<U, Q>>
{
    constexpr auto operator()(const xtras::value::Value<U, Q> v) const noexcept -> std::size_t
    {
